...
```{r, message=FALSE, echo = FALSE, fig.align='center', fig.show='hold', fig.width=5, fig.height=4}
...
```{r, message=FALSE, echo = FALSE, fig.align='center', fig.show='hold', fig.width=4, fig.height=4}
...
ci.plot(simZ_genY_white, ylim = 0:1, ylab = "Probability of voting", main = "White Millennial Man")
#Now, Baby Boomer
